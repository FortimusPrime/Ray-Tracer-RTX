...
// Common Getters
Vector3D Primitive::getColor() { return this->color; }
int Primitive::getSpecular() { return this->specular; }
double Primitive::getReflective() { return this->reflective; }
string Primitive::getType() { return this->objectType; }

// Sphere getters
Vector3D Primitive::getCenter() { return this->center; }

double Primitive::getRadius() { return this->radius; }

// Triangle getters
Vector3D Primitive::getPointA() { return this->pointA; }

Vector3D Primitive::getPointB() { return this->pointB; }

Vector3D Primitive::getPointC() { return this->pointC; }

Vector3D Primitive::getNormal() { return this->normal; }